...
function poc() {
	...
	alert(" 💾  سيتم الآن البدء بعملية التهكير ... للإستمرار اضغط على موافق 💾  \n\n 🕹️ ورشة عدن لصيانة الالكترونيات 🕹️ \n 🗺️ عدن - المعلاء - خلف المعلا بلازا - بجانب عمارة الصديق البيضاء 🗺️ \n 📱 T: 777854562 📱 \n 🌹 المهندس / محمد ناجي 🌹 ");
    var p_s = '';
    p_s += ptrToString(26);
